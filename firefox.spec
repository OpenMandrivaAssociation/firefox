...
rm -rf third_party/python/{aiohttp,attrs,certifi,chardet,colorama,distro,idna,jsonschema,multidict,packaging,pip,pip_tools,ply,pyparsing,pyrsistent,requests,setuptools,urllib3,wheel,yarl,zipp}
